...
TEX_FIGURE_FILENAMES = {
    ...
    "b.jpg",
    "framework.png",
    "resnet_1dcnn_architecture_corrected_editable.png",
    "residual_1d_convolution_block_editable.png",
    "baseline_type1_fit.png",
    "baseline_type2_fit.png",
    "baseline_dummy_fit.png",
    "type2_direct_huber_fit.png",
    "transfer_t1_to_t2_huber_fit.png",
}

MANUSCRIPT_TABLE_FILENAMES = {
    "manuscript_key_values.csv",
    "manuscript_table_road_types.csv",
    "manuscript_table_descriptive_statistics.csv",
    "manuscript_table_variables.csv",
    "manuscript_table_baseline_results.csv",
    "manuscript_table_baseline_coefficients.csv",
    "manuscript_table_dl_results.csv",
    "manuscript_table_xai_results.csv",
}
...
def is_tex_figure_path(path):
    return _basename(path) in TEX_FIGURE_FILENAMES


# Do not monkey-patch plt.savefig. The full pipeline is allowed to create temporary
# intermediate files, and cleanup_non_tex_generated_outputs() removes non-manuscript
# files at the end. This avoids recursive savefig wrapping when the same Colab cell
# is executed more than once.
import importlib

# Recover a clean matplotlib.pyplot module if an earlier run patched savefig/show.
if getattr(plt.savefig, "__name__", "") == "_tex_filtered_savefig" or getattr(plt.show, "__name__", "") == "_tex_filtered_show":
    plt = importlib.reload(plt)

_ORIGINAL_PLT_SHOW = plt.show


def _tex_filtered_show(*args, **kwargs):
    """Suppress notebook display in TEX-only mode while allowing files to be saved."""
    if TEX_ONLY_OUTPUT:
        plt.close("all")
        return None
...
if TEX_ONLY_OUTPUT:
    plt.show = _tex_filtered_show


def manuscript_table_dataframes():
    """Return only the numerical tables and manuscript tables that appear in the TEX file."""
    tables = {}

    tables["manuscript_key_values.csv"] = pd.DataFrame([
        {"Item": "PCI scale", "Value": "0--100", "Context": "PCI is described as a standardised condition scale."},
        {"Item": "Data collection period", "Value": "February 2019 to May 2025", "Context": "PCI field survey period."},
        {"Item": "Train:test split", "Value": "4:1", "Context": "80% training and 20% held-out testing."},
        {"Item": "Training subset", "Value": "80%", "Context": "Observed field dataset split."},
        {"Item": "Testing subset", "Value": "20%", "Context": "Observed field dataset split."},
        {"Item": "Initial PCI", "Value": "100", "Context": "PCI_i in the deterioration equation."},
        {"Item": "Maintenance threshold", "Value": "40", "Context": "Kinmen Island maintenance threshold."},
        {"Item": "PCI loss term", "Value": "60", "Context": "PCI_g in the deterioration equation."},
        {"Item": "ESAL axle load", "Value": "80 kN (18,000 lb)", "Context": "Equivalent single axle load definition."},
        {"Item": "SAMI dummy, without SAMI", "Value": "0", "Context": "Dummy variable D."},
        {"Item": "SAMI dummy, with SAMI", "Value": "1", "Context": "Dummy variable D."},
        {"Item": "Original input variables", "Value": "4", "Context": "Mr, SN, ALT, and ESALs."},
        {"Item": "Expanded feature dimension", "Value": "14", "Context": "Second-order polynomial feature expansion."},
    ])

    tables["manuscript_table_road_types.csv"] = pd.DataFrame([
        {"No.": 1, "SAMI": "Absent", "ALT (cm)": 10, "Aggregate layer thickness (cm)": 30, "PCC thickness (cm)": 0, "SN": 6.5, "Group": "--"},
        {"No.": 2, "SAMI": "Absent", "ALT (cm)": 8, "Aggregate layer thickness (cm)": 30, "PCC thickness (cm)": 0, "SN": 5.8, "Group": "--"},
        {"No.": 3, "SAMI": "Absent", "ALT (cm)": 15, "Aggregate layer thickness (cm)": 35, "PCC thickness (cm)": 0, "SN": 8.75, "Group": "--"},
        {"No.": 4, "SAMI": "Absent", "ALT (cm)": 10, "Aggregate layer thickness (cm)": 0, "PCC thickness (cm)": 20, "SN": 6.5, "Group": "Type 1"},
        {"No.": 5, "SAMI": "Absent", "ALT (cm)": 15, "Aggregate layer thickness (cm)": 0, "PCC thickness (cm)": 20, "SN": 8.25, "Group": "Type 1"},
        {"No.": 6, "SAMI": "Present", "ALT (cm)": 10, "Aggregate layer thickness (cm)": 0, "PCC thickness (cm)": 20, "SN": 6.5, "Group": "Type 2"},
        {"No.": 7, "SAMI": "Present", "ALT (cm)": 15, "Aggregate layer thickness (cm)": 0, "PCC thickness (cm)": 20, "SN": 8.25, "Group": "Type 2"},
    ])

    tables["manuscript_table_descriptive_statistics.csv"] = pd.DataFrame([
        {"Statistic": "Mean", "Without SAMI Mr": "19.98", "Without SAMI SN": "7.37", "Without SAMI ALT": "125.16", "Without SAMI ESALs": "1,160,962", "Without SAMI PCI": "69.75", "With SAMI Mr": "11.61", "With SAMI SN": "7.39", "With SAMI ALT": "125.57", "With SAMI ESALs": "1,430,361", "With SAMI PCI": "75.02"},
        {"Statistic": "Std. Dev.", "Without SAMI Mr": "6.48", "Without SAMI SN": "0.88", "Without SAMI ALT": "25.04", "Without SAMI ESALs": "410,789", "Without SAMI PCI": "14.48", "With SAMI Mr": "2.60", "With SAMI SN": "0.88", "With SAMI ALT": "25.14", "With SAMI ESALs": "562,857", "With SAMI PCI": "11.91"},
        {"Statistic": "Min.", "Without SAMI Mr": "8.40", "Without SAMI SN": "6.50", "Without SAMI ALT": "100.00", "Without SAMI ESALs": "345,060", "Without SAMI PCI": "41.00", "With SAMI Mr": "6.10", "With SAMI SN": "6.50", "With SAMI ALT": "100.00", "With SAMI ESALs": "511,731", "With SAMI PCI": "53.00"},
        {"Statistic": "Max.", "Without SAMI Mr": "31.00", "Without SAMI SN": "8.25", "Without SAMI ALT": "150.00", "Without SAMI ESALs": "1,856,540", "Without SAMI PCI": "99.00", "With SAMI Mr": "16.90", "With SAMI SN": "8.25", "With SAMI ALT": "150.00", "With SAMI ESALs": "2,202,598", "With SAMI PCI": "99.00"},
    ])

    tables["manuscript_table_variables.csv"] = pd.DataFrame([
        {"Symbol": "PCI", "Variable": "Pavement condition index", "Unit": "--", "Definition": "Composite indicator of pavement surface condition, reflecting observed distress such as cracking, potholes, and rutting.", "Source / measurement": "Visual pavement survey conducted according to ASTM D6433."},
        {"Symbol": "ESALs", "Variable": "Cumulative equivalent single axle loads", "Unit": "repetitions of 80 kN axle loads", "Definition": "Accumulated traffic loading applied to the pavement section up to the survey time.", "Source / measurement": "Estimated from field traffic surveys, design traffic records, projected service life, and calibrated using traffic surveillance data."},
        {"Symbol": "Mr", "Variable": "Subgrade resilient modulus", "Unit": "kgf/cm^2", "Definition": "Indicator of subgrade support condition used to represent the bearing capacity of the subgrade.", "Source / measurement": "Obtained from design documents, field investigation records, or engineering estimates for each pavement section."},
        {"Symbol": "SN", "Variable": "Structural number", "Unit": "--", "Definition": "Index representing the combined structural capacity of the pavement section.", "Source / measurement": "Calculated from pavement layer composition, design layer thicknesses, and structural design records following the AASHTO structural-number concept, SN=sum_i a_i h_i m_i."},
        {"Symbol": "ALT", "Variable": "Asphalt layer thickness", "Unit": "mm", "Definition": "Thickness of the asphalt concrete overlay layer above the PCC slab.", "Source / measurement": "Obtained from design drawings and construction records."},
        {"Symbol": "wt", "Variable": "Cumulative ESALs up to time t", "Unit": "repetitions of 80 kN axle loads", "Definition": "Same traffic loading variable expressed at time t in the PCI deterioration equation.", "Source / measurement": "Derived from the same ESAL estimation procedure described above."},
        {"Symbol": "D", "Variable": "SAMI dummy variable", "Unit": "--", "Definition": "Indicator variable used in the unified baseline model to distinguish pavement sections without and with a stress-absorbing membrane interlayer. D=0 denotes pavements without SAMI and D=1 denotes pavements with SAMI.", "Source / measurement": "Assigned according to pavement structure classification from design and construction records."},
        {"Symbol": "rho", "Variable": "Scale parameter in the PCI deterioration equation", "Unit": "--", "Definition": "Intermediate regression term combining the contributions of Mr, SN, and ALT in the group-specific baseline model.", "Source / measurement": "Estimated through nonlinear regression."},
        {"Symbol": "beta", "Variable": "Shape parameter in the PCI deterioration equation", "Unit": "--", "Definition": "Intermediate regression term controlling the deterioration rate in the group-specific baseline model.", "Source / measurement": "Estimated through nonlinear regression."},
        {"Symbol": "beta_D", "Variable": "Shape parameter in the unified dummy equation", "Unit": "--", "Definition": "Intermediate regression term in the unified baseline model, allowing the deterioration-rate component to vary with Mr, SN, ALT, and the SAMI dummy variable.", "Source / measurement": "Estimated through nonlinear regression using the pooled dataset."},
        {"Symbol": "p1--p8", "Variable": "Regression coefficients", "Unit": "--", "Definition": "Model coefficients in the group-specific PCI equation and the unified baseline formulation.", "Source / measurement": "Calibrated from the observed field data."},
        {"Symbol": "p9", "Variable": "SAMI effect on beta_D", "Unit": "--", "Definition": "Additional regression coefficient representing the effect of the SAMI dummy variable on the shape term in the unified baseline model.", "Source / measurement": "Calibrated from the pooled observed field data."},
    ])

    tables["manuscript_table_baseline_results.csv"] = pd.DataFrame([
        {"Group": "Type 1 (without SAMI)", "Split": "Train", "R2": "0.9744", "RMSE": "2.302", "MAE": "1.956", "Residual Mean": "0.106", "Residual STD": "2.304", "Residual Min": "-4.176", "Residual Max": "6.701"},
        {"Group": "Type 1 (without SAMI)", "Split": "Test", "R2": "0.9749", "RMSE": "2.334", "MAE": "2.025", "Residual Mean": "0.150", "Residual STD": "2.348", "Residual Min": "-4.051", "Residual Max": "4.627"},
        {"Group": "Type 2 (with SAMI)", "Split": "Train", "R2": "0.5663", "RMSE": "7.199", "MAE": "6.041", "Residual Mean": "0.051", "Residual STD": "7.251", "Residual Min": "-14.709", "Residual Max": "15.391"},
        {"Group": "Type 2 (with SAMI)", "Split": "Test", "R2": "0.8112", "RMSE": "6.419", "MAE": "5.859", "Residual Mean": "-0.631", "Residual STD": "6.574", "Residual Min": "-10.709", "Residual Max": "7.473"},
        {"Group": "Unified baseline with SAMI dummy", "Split": "Train", "R2": "0.8286", "RMSE": "5.889", "MAE": "4.499", "Residual Mean": "0.209", "Residual STD": "5.891", "Residual Min": "-23.203", "Residual Max": "21.380"},
        {"Group": "Unified baseline with SAMI dummy", "Split": "Test", "R2": "0.7024", "RMSE": "7.354", "MAE": "5.889", "Residual Mean": "1.134", "Residual STD": "7.312", "Residual Min": "-19.759", "Residual Max": "21.126"},
    ])

    tables["manuscript_table_baseline_coefficients.csv"] = pd.DataFrame([
        {"Parameter": "p1", "Model term": "Intercept in rho", "Type 1 without SAMI": "1.7104 x 10^6", "Type 2 with SAMI": "3.8940 x 10^6", "Unified model with SAMI dummy": "2.2447 x 10^6"},
        {"Parameter": "p2", "Model term": "Coefficient of Mr in rho", "Type 1 without SAMI": "3.8226 x 10^3", "Type 2 with SAMI": "1.4238 x 10^4", "Unified model with SAMI dummy": "8.9211 x 10^-1"},
        {"Parameter": "p3", "Model term": "Coefficient of SN in rho", "Type 1 without SAMI": "0.0000", "Type 2 with SAMI": "6.3681 x 10^3", "Unified model with SAMI dummy": "2.6816 x 10^4"},
        {"Parameter": "p4", "Model term": "Coefficient of ALT in rho", "Type 1 without SAMI": "1.4528 x 10^3", "Type 2 with SAMI": "4.7924 x 10^2", "Unified model with SAMI dummy": "1.3811 x 10^1"},
        {"Parameter": "p5", "Model term": "Base coefficient in beta", "Type 1 without SAMI": "1.5925 x 10^-2", "Type 2 with SAMI": "6.5824 x 10^-2", "Unified model with SAMI dummy": "1.1125 x 10^-2"},
        {"Parameter": "p6", "Model term": "Exponent of Mr in beta or beta_D", "Type 1 without SAMI": "0.1918", "Type 2 with SAMI": "0.1332", "Unified model with SAMI dummy": "0.2279"},
        {"Parameter": "p7", "Model term": "Exponent of SN in beta or beta_D", "Type 1 without SAMI": "0.3532", "Type 2 with SAMI": "0.0412", "Unified model with SAMI dummy": "0.1810"},
        {"Parameter": "p8", "Model term": "Exponent of ALT in beta or beta_D", "Type 1 without SAMI": "0.6588", "Type 2 with SAMI": "0.4379", "Unified model with SAMI dummy": "0.7040"},
        {"Parameter": "p9", "Model term": "SAMI dummy coefficient in beta_D", "Type 1 without SAMI": "--", "Type 2 with SAMI": "--", "Unified model with SAMI dummy": "1.2469 x 10^-2"},
    ])

    tables["manuscript_table_dl_results.csv"] = pd.DataFrame([
        {"Model": "Direct Type 1 model", "Loss": "MSE", "R2": "0.9793", "RMSE": "2.124", "MAE": "1.648", "Mean Res.": "1.256", "Std. Res.": "1.726", "Min Res.": "-2.125", "Max Res.": "5.024"},
        {"Model": "Direct Type 1 model", "Loss": "Huber", "R2": "0.9494", "RMSE": "3.317", "MAE": "2.901", "Mean Res.": "2.749", "Std. Res.": "1.870", "Min Res.": "-1.980", "Max Res.": "6.256"},
        {"Model": "Direct Type 2 model", "Loss": "MSE", "R2": "0.6687", "RMSE": "8.504", "MAE": "7.195", "Mean Res.": "5.241", "Std. Res.": "6.892", "Min Res.": "-10.838", "Max Res.": "16.838"},
        {"Model": "Direct Type 2 model", "Loss": "Huber", "R2": "0.6427", "RMSE": "8.832", "MAE": "7.506", "Mean Res.": "5.077", "Std. Res.": "7.436", "Min Res.": "-10.533", "Max Res.": "18.169"},
        {"Model": "TL model (Type 1->Type 2)", "Loss": "MSE", "R2": "0.7499", "RMSE": "7.389", "MAE": "5.749", "Mean Res.": "2.614", "Std. Res.": "7.111", "Min Res.": "-7.469", "Max Res.": "18.451"},
        {"Model": "TL model (Type 1->Type 2)", "Loss": "Huber", "R2": "0.8404", "RMSE": "5.904", "MAE": "4.802", "Mean Res.": "0.621", "Std. Res.": "6.041", "Min Res.": "-9.727", "Max Res.": "11.784"},
    ])

    tables["manuscript_table_xai_results.csv"] = pd.DataFrame([
        {"Group": "Type 1, no SAMI", "Model": "Symbolic regression", "R2": "0.9691", "RMSE": "2.590", "MAE": "2.170", "Mean Res.": "0.256", "Std. Res.": "2.598", "Min Res.": "-4.631", "Max Res.": "4.893"},
        {"Group": "Type 1, no SAMI", "Model": "Decision tree", "R2": "0.9744", "RMSE": "2.358", "MAE": "1.782", "Mean Res.": "-0.282", "Std. Res.": "2.360", "Min Res.": "-6.500", "Max Res.": "4.333"},
        {"Group": "Type 2, with SAMI", "Model": "Symbolic regression", "R2": "0.8246", "RMSE": "6.188", "MAE": "5.568", "Mean Res.": "-0.559", "Std. Res.": "6.341", "Min Res.": "-10.854", "Max Res.": "7.482"},
        {"Group": "Type 2, with SAMI", "Model": "Decision tree", "R2": "0.8175", "RMSE": "6.312", "MAE": "5.768", "Mean Res.": "0.282", "Std. Res.": "6.488", "Min Res.": "-9.133", "Max Res.": "8.667"},
    ])

    return tables


def export_manuscript_tables_from_tex_values(output_dir=MANUSCRIPT_OUTPUT_DIR):
    """Write only the table/value CSV files whose contents appear in the TEX manuscript."""
    os.makedirs(output_dir, exist_ok=True)
    written = []
    for filename, df in manuscript_table_dataframes().items():
...
def cleanup_non_tex_generated_outputs(output_dir=MANUSCRIPT_OUTPUT_DIR):
    """Remove known non-manuscript outputs generated by the full pipeline."""
    keep = set(TEX_FIGURE_FILENAMES) | set(MANUSCRIPT_TABLE_FILENAMES)
    known_generated = {
        "descriptive_stats_without_SAMI.csv",
        "descriptive_stats_with_SAMI.csv",
        "descriptive_stats_combined.csv",
        "descriptive_stats_combined_rounded.csv",
        "baseline_eq1_type1_results.csv",
        "baseline_eq1_type2_results.csv",
        "baseline_eq1_dummy_combined_results.csv",
        "baseline_eq1_type1_parameters.csv",
        "baseline_eq1_type2_parameters.csv",
        "baseline_eq1_dummy_parameters.csv",
        "baseline_eq1_summary.csv",
        "baseline_fit_combined.png",
        "resnet_1dcnn_transfer_summary.csv",
        "type2_direct_huber_predictions.csv",
        "transfer_t1_to_t2_huber_predictions.csv",
        "transfer_fit_combined.png",
        "explainable_ai_combined_summary.csv",
        "transfer_t1_to_t2_huber_sensitivity_summary.csv",
        "Type_1_without_SAMI_xai_summary.csv",
        "Type_2_with_SAMI_xai_summary.csv",
        "Type_1_without_SAMI_symbolic_predictions.csv",
        "Type_2_with_SAMI_symbolic_predictions.csv",
        "Type_1_without_SAMI_tree_predictions.csv",
        "Type_2_with_SAMI_tree_predictions.csv",
        "Type_1_without_SAMI_symbolic_sensitivity.csv",
        "Type_2_with_SAMI_symbolic_sensitivity.csv",
        "Type_1_without_SAMI_tree_sensitivity.csv",
        "Type_2_with_SAMI_tree_sensitivity.csv",
        "Type_1_without_SAMI_symbolic_equation.txt",
        "Type_2_with_SAMI_symbolic_equation.txt",
        "Type_1_without_SAMI_tree_rules.txt",
        "Type_2_with_SAMI_tree_rules.txt",
    }
    removed = []
    for name in known_generated:
        if name in keep:
            continue
        ...
        if os.path.exists(path):
            os.remove(path)
            removed.append(path)
    for folder_name in ["sensitivity_outputs_dl", "sensitivity_outputs_xai", "model_diagrams"]:
...
def print_tex_only_outputs(written_tables=None, output_dir=MANUSCRIPT_OUTPUT_DIR):
    """Print a concise manifest of outputs constrained to the TEX manuscript."""
    print("\n" + "=" * 90)
    print("TEX-only manuscript outputs")
    print("=" * 90)
    if written_tables:
        print("\nTables and values exported from the TEX manuscript:")
        for path in written_tables:
            print(path)
    print("\nFigure files appearing in the TEX manuscript:")
    for name in sorted(TEX_FIGURE_FILENAMES):
        path = os.path.join(output_dir, name)
        status = "exists" if os.path.exists(path) else "not generated in this run"
        print(f"{path} [{status}]")


def export_tex_only_outputs(output_dir=MANUSCRIPT_OUTPUT_DIR):
    """Export only manuscript-approved outputs based on the uploaded TEX file."""
    os.makedirs(output_dir, exist_ok=True)

    # The TEX manuscript states that the polynomial-expanded input has 14 dimensions.
    # These two architecture figures are included in the TEX file and can be generated without the data CSVs.
    try:
        save_resnet_1dcnn_architecture(
            input_len=14,
            out_path=os.path.join(output_dir, "resnet_1dcnn_architecture_corrected_editable.png")
        )
        save_residual_block_diagram(
            out_path=os.path.join(output_dir, "residual_1d_convolution_block_editable.png")
        )
    except NameError:
        # When this helper is inspected before all plotting functions are defined, table export still works.
        pass

    written_tables = export_manuscript_tables_from_tex_values(output_dir=output_dir)
    cleanup_non_tex_generated_outputs(output_dir=output_dir)
    print_tex_only_outputs(written_tables=written_tables, output_dir=output_dir)
...
def save_workflow_diagram(steps, title, out_path, figsize=(14, 3.2)):
    ...
    This is intended for manuscript-level model explanation figures.
    """
...
def save_residual_block_diagram(out_path=None):
    """
    Save a schematic of the residual 1D convolution block used in ResidualBlock1D.
    """
    ensure_model_diagram_dir()
    ...
    # Skip connection from input to addition
    ax.annotate(
        "",
        xy=(xs[7], y + 0.12),
        xytext=(xs[0], y + 0.12),
        arrowprops=dict(arrowstyle="->", linewidth=1.2, connectionstyle="arc3,rad=-0.25")
    )
    ax.text(
        (xs[0] + xs[7]) / 2,
        y + 0.25,
...
def save_dataframe_as_table_png(df, title, out_path, figsize=None):
    ...
    Useful for model architecture summary tables.
    """
    ensure_model_diagram_dir()
...
def run_part_a():
    ...
    for col in ["Mr", "SN", "ALT", "ESALs", "PCI"]:
        combined[("Without SAMI", col)] = stats0.loc[["Count", "Mean", "Std. Dev.", "Min.", "Max."], col].values

    for col in ["Mr", "SN", "ALT", "ESALs", "PCI"]:
        combined[("With SAMI", col)] = stats1.loc[["Count", "Mean", "Std. Dev.", "Min.", "Max."], col].values
...
def fit_eq1_baseline_train_test(df, group_name="Baseline model",
                                test_size=0.2, random_state=SEED, initial_guess=None):
    ...
    if initial_guess is None:
        initial_guess = [
            1658000.23, 3728.61, 9995.13, 1287.65,
            0.01553, 0.2066, 0.2730, 0.6887
        ]
    ...
    print(f"rho  = {params[0]:.6f} + {params[1]:.6f}*Mr + {params[2]:.6f}*SN + {params[3]:.6f}*ALT")
    print(f"beta = {params[4]:.8f} * Mr^{params[5]:.6f} * SN^{params[6]:.6f} * ALT^{params[7]:.6f}")
...
def fit_eq1_baseline_with_dummy_train_test(df, group_name="Unified model with SAMI dummy",
                                           test_size=0.2, random_state=SEED, initial_guess=None):
    train_df, test_df = split_df_train_test(df, test_size=test_size, random_state=random_state)
    ...
    if initial_guess is None:
        initial_guess = [
            1658000.23, 3728.61, 9995.13, 1287.65,
            0.01553, 0.0, 0.2066, 0.2730, 0.6887
        ]
    ...
    print("PCI = 100 - 60 * (ESALs / rho)^beta")
    print(f"rho  = {params[0]:.6f} + {params[1]:.6f}*Mr + {params[2]:.6f}*SN + {params[3]:.6f}*ALT")
    print(f"beta = ({params[4]:.8f} + {params[5]:.8f}*SAMI) * Mr^{params[6]:.6f} * SN^{params[7]:.6f} * ALT^{params[8]:.6f}")
...
def run_part_b():
    ...
    baseline_t1 = fit_eq1_baseline_train_test(df_type1, "Type 1 (without SAMI)", test_size=0.2, random_state=SEED)
    baseline_t2 = fit_eq1_baseline_train_test(df_type2, "Type 2 (with SAMI)", test_size=0.2, random_state=SEED)
    baseline_dummy = fit_eq1_baseline_with_dummy_train_test(df_combined, "Unified baseline with SAMI dummy", test_size=0.2, random_state=SEED)
    ...
    summary_baseline = pd.DataFrame([
        ...
        {"Group": "Unified baseline with SAMI dummy", "Split": "Train", **baseline_dummy["train_metrics"]},
        {"Group": "Unified baseline with SAMI dummy", "Split": "Test",  **baseline_dummy["test_metrics"]}
    ])
...
def run_transfer_t1_to_t2(data_t1, data_t2, loss_name="huber",
                          pretrain_epochs=300, finetune_epochs=250):
...
# ============================================================
# PART C-1. Sensitivity analysis for transfer learning model
# ============================================================
def predict_pci_from_raw_dl(model, poly, scaler, x_raw_row, device=device):
    x_raw_row = np.asarray(x_raw_row, dtype=float).reshape(1, -1)
    x_poly = poly.transform(x_raw_row)
    x_std = scaler.transform(x_poly)
    x_tensor = torch.tensor(x_std, dtype=torch.float32).unsqueeze(1).to(device)
    model.eval()
    with torch.no_grad():
...
def one_way_sensitivity_dl(model, poly, scaler, base_values, feature_name, feature_range, n_points=100, device=device):
    rows = []
    sweep_vals = np.linspace(feature_range[0], feature_range[1], n_points)
    for val in sweep_vals:
        x = [base_values[k] for k in RAW_FEATURE_COLS]
        idx = RAW_FEATURE_COLS.index(feature_name)
        x[idx] = float(val)
        pred = predict_pci_from_raw_dl(model=model, poly=poly, scaler=scaler, x_raw_row=x, device=device)
        row = {k: float(base_values[k]) for k in RAW_FEATURE_COLS}
        row[feature_name] = float(val)
        row["Predicted_PCI"] = float(pred)
        rows.append(row)
    return pd.DataFrame(rows)


def compute_sensitivity_metrics(df_sens, feature_name):
    x = df_sens[feature_name].values
    y = df_sens["Predicted_PCI"].values
    pci_min = float(y[0])
    pci_max = float(y[-1])
    delta = float(pci_max - pci_min)
    if delta > 0:
        trend = "increase"
    elif delta < 0:
        trend = "decrease"
        ...
        trend = "flat"
    slope_global = float((y[-1] - y[0]) / (x[-1] - x[0])) if (x[-1] - x[0]) != 0 else np.nan
    return {
        ...
        "PCI_at_Min": pci_min,
        "PCI_at_Max": pci_max,
        "DeltaPCI_MaxMinusMin": delta,
        "GlobalSlope": slope_global,
        "Trend": trend
    }


def plot_one_way_sensitivity(df_sens, feature_name, title, save_path=None):
    plt.figure(figsize=(6, 4.5))
    plt.plot(df_sens[feature_name], df_sens["Predicted_PCI"], linewidth=2)
...
def run_sensitivity_suite_dl(model, poly, scaler, df_reference, group_name="Transfer_T1_to_T2_Huber",
    ...
    base_values = {
        ...
        "ALT": float(df_reference["ALT"].median()),
        "ESALs": float(df_reference["ESALs"].median())
    }
    print("\n" + "=" * 60)
    print(f"Sensitivity analysis for: {group_name}")
    print("Baseline values:", base_values)
    print("=" * 60)
    summary_rows = []
    curve_data = {}
    for feat in RAW_FEATURE_COLS:
        feat_min = float(df_reference[feat].min())
        feat_max = float(df_reference[feat].max())
        df_sens = one_way_sensitivity_dl(
            model=model, poly=poly, scaler=scaler, base_values=base_values,
        ...
        metrics["Base_ALT"] = base_values["ALT"]
...
def predict_xai_from_raw(model, scaler, x_raw_row):
    x_raw_row = np.asarray(x_raw_row, dtype=float).reshape(1, -1)
    x_scaled = scaler.transform(x_raw_row)
    y_pred = model.predict(x_scaled)[0]
    return float(y_pred)


def one_way_sensitivity_xai(model, scaler, base_values, feature_name, feature_range, n_points=100):
    rows = []
    sweep_vals = np.linspace(feature_range[0], feature_range[1], n_points)
    for val in sweep_vals:
        x = [base_values[k] for k in RAW_FEATURE_COLS]
        idx = RAW_FEATURE_COLS.index(feature_name)
        x[idx] = float(val)
        pred = predict_xai_from_raw(model=model, scaler=scaler, x_raw_row=x)
        row = {k: float(base_values[k]) for k in RAW_FEATURE_COLS}
        row[feature_name] = float(val)
        row["Predicted_PCI"] = float(pred)
        rows.append(row)
...
def plot_one_way_sensitivity_xai(df_sens, feature_name, title, save_path=None):
    plt.figure(figsize=(6, 4.5))
    plt.plot(df_sens[feature_name], df_sens["Predicted_PCI"], linewidth=2)
    plt.xlabel(feature_name)
    plt.ylabel("Predicted PCI")
...
def run_sensitivity_suite_xai(model, scaler, df_reference, group_name, model_name, output_dir="/content/sensitivity_outputs_xai", n_points=100):
    ...
    for feat in RAW_FEATURE_COLS:
        feat_min = float(df_reference[feat].min())
        feat_max = float(df_reference[feat].max())
        df_sens = one_way_sensitivity_xai(
            model=model, scaler=scaler, base_values=base_values,
...
def run_explainable_models(df, group_name="Type 1", test_size=0.2, random_state=SEED):
    ...
    sym_curve_out = run_sensitivity_suite_xai(
        model=sym,
        scaler=scaler,
        df_reference=df,
        group_name=group_name,
        model_name="SymbolicRegression",
        output_dir="/content/sensitivity_outputs_xai",
        n_points=100
    )
    tree_curve_out = run_sensitivity_suite_xai(
        model=best_tree,
        scaler=scaler,
        df_reference=df,
        group_name=group_name,
    ...
    return {
        ...
        "symbolic_curve_summary": sym_curve_out["summary"],
        "tree_curve_summary": tree_curve_out["summary"]
    }
...
def run_full_pipeline():
    ...
    save_residual_block_diagram(
        out_path="/content/residual_1d_convolution_block_editable.png"
    )

    save_resnet_1dcnn_architecture(
        input_len=input_len,
        out_path="/content/resnet_1dcnn_architecture_corrected_editable.png"
    )
    ...
    for loss_name in ["mse", "huber"]:
        res_t1_direct = run_direct_model(
            data_t1, group_name="Type 1", loss_name=loss_name, max_epochs=300
        )
        plot_history(res_t1_direct["history"], f"Type 1 direct - {loss_name.upper()} loss")
        plot_pred_vs_true(
            res_t1_direct["y_true"], res_t1_direct["y_pred"],
            f"Type 1 direct - {loss_name.upper()} loss"
        )
        results_summary.append({"Model": "Type1_direct", "Loss": loss_name.upper(), **res_t1_direct["metrics"]})
        saved_predictions[f"Type1_direct_{loss_name}"] = (
            res_t1_direct["y_true"], res_t1_direct["y_pred"]
        )

        res_t2_direct = run_direct_model(
            data_t2, group_name="Type 2", loss_name=loss_name, max_epochs=300
        )
        plot_history(res_t2_direct["history"], f"Type 2 direct - {loss_name.upper()} loss")
        plot_pred_vs_true(
            res_t2_direct["y_true"], res_t2_direct["y_pred"],
            f"Type 2 direct - {loss_name.upper()} loss"
        )
        results_summary.append({"Model": "Type2_direct", "Loss": loss_name.upper(), **res_t2_direct["metrics"]})
    ...
    for loss_name in ["mse", "huber"]:
        res_tf = run_transfer_t1_to_t2(
            data_t1, data_t2, loss_name=loss_name,
            pretrain_epochs=300, finetune_epochs=250
        )
        ...
        plot_pred_vs_true(
            res_tf["y_true"], res_tf["y_pred"],
            f"Transfer T1→T2 - {loss_name.upper()} loss"
        )
        results_summary.append({"Model": "Transfer_T1_to_T2", "Loss": loss_name.upper(), **res_tf["metrics"]})
    ...
    if "huber" in transfer_results:
        dl_sens_out = run_sensitivity_suite_dl(
            model=transfer_results["huber"]["model"],
            poly=data_t1["poly"],
            scaler=data_t1["scaler"],
            df_reference=df_type2,
            group_name="Transfer_T1_to_T2_Huber",
            output_dir="/content/sensitivity_outputs_dl",
            n_points=100,
            device=device
        )
    ...
    combined_summary_xai = pd.concat([res_xai_t1["summary"], res_xai_t2["summary"]], ignore_index=True)
    ...
    print("\nFull modelling pipeline finished.")
    print("Only TEX manuscript outputs will be retained by export_tex_only_outputs().")

    # Example download
    # if files is not None:
    #     files.download("/content/manuscript_table_dl_results.csv")
